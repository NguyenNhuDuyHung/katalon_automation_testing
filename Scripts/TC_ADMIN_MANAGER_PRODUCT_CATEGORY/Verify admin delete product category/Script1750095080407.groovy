...
WebUI.click(findTestObject('Manager_Product_Category/Page_Manager_Product_Category/button_delete_product_category'))

WebUI.waitForAlert(10)

WebUI.acceptAlert()

WebUI.waitForElementVisible(findTestObject('Manager_Product_Category/Page_Manager_Product_Category/div_Notification_Success'), 
    10)
