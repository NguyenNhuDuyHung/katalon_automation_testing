...
WebUI.waitForElementPresent(findTestObject('Manager_User/Page_Create_User/div_notification_error'), 10)

WebUI.verifyElementText(findTestObject('Manager_User/Page_Create_User/div_notification_error'), expected_notification)
