...
WebUI.click(findTestObject('Object Repository/Manage Voucher/Page_Quan_ly_khuyen_mai/a_Create_voucher'))
...
WebUI.click(findTestObject('Object Repository/Manage Voucher/Page_Them_khuyen_mai/button_create'))
