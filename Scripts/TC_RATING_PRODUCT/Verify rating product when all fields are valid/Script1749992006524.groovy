...
WebUI.click(findTestObject('Rating_Product/Page_product_detail/icon_star'))
...
WebUI.verifyMatch(alertText, expected_notification, false, FailureHandling.STOP_ON_FAILURE)
